                ...
                <div class="device">
                    <div class="bigDiv" style="width:100%;height:100%;overflow:auto;">
                        ...
                        <div>
                            ...
                            <editor style="border-radius:0;" @change="updateData" :content="dailyInfoData.reportcontent" :height="480" :z-index="1000" :auto-height="true" :show-module-name="false"></editor>
                        </div>
...
export default {
  ...
  methods: {
    ...
    saveTextClick() {
      // console.log('this.dailyInfoData',this.dailyInfoData);
      this.submit(this.dailyInfoData);
    },
    updateData(data) {
