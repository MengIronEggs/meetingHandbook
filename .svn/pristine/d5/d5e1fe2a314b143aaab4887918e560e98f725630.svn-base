    ...
    <div class="preview-component">
        ...
        >
            <div class="iphone-box" :style="{backgroundImage: `url(${iphoneImage})`}">
                ...
                <iframe id="preview" v-if="preview" class="webview" :src="`https://mt.guoanfamily.com/meetWap/${url}`" scrolling="no"
                        frameborder="0" width="262px" height="424px"></iframe>

                <div class="qrcode">
                    <qrcode :value="`https://mt.guoanfamily.com/meetWap/${reallyUrl}`" :options="{ size: 150 }"></qrcode>
                    <el-alert
                        title="扫描二维码在手机上预览"
                        type="info"
                        show-icon
