                  ...
                  <div v-if="formType === 'company'">
                      <el-form label-width="80px">
                        ...
                        <el-form-item label="管理人">
                            <el-input v-model="username" placeholder="输入姓名或电话搜索">
                      ...
                      <el-button style="margin-left:40px;width:50%;margin-top:20px;" type="primary" size="small" @click= 'exitClcik'>编辑</el-button>
